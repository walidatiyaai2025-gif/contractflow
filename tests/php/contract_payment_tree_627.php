...
sc_627_assert(str_contains($bootstrap, 'Version: 0.3.23') && str_contains($bootstrap, "SAFECONTRACTS_VERSION', '0.3.23'"), 'plugin version advances with the current integrated release candidate');
