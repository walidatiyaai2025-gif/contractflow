...
sc_627_assert(str_contains($bootstrap, 'Version: 0.3.6') && str_contains($bootstrap, "SAFECONTRACTS_VERSION', '0.3.6'"), 'plugin version is locked to the final 0.3.6 integrated release');
