...
sc_627_assert(str_contains($bootstrap, 'Version: 0.3.2') && str_contains($bootstrap, "SAFECONTRACTS_VERSION', '0.3.2'"), 'plugin version is locked to the final 0.3.2 integrated release');
