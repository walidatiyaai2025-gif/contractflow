...
sc_contract_assert(Migrator::LATEST_VERSION === '1.4.0', 'contract finance migration is the current schema version');
sc_contract_assert(get_option(Migrator::VERSION_OPTION) === '1.4.0', 'current contract migration version is stored');
sc_contract_assert(count($GLOBALS['sc_test_dbdelta']) === 6, 'contract, finance and attachment schema runs without replay');
