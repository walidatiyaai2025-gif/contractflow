...
sc_665_sync_assert(
    str_contains($bootstrap, 'Version: 0.3.25') && str_contains($bootstrap, "SAFECONTRACTS_VERSION', '0.3.25'"),
    'upgrade/manual reconciliation ships only in forward release 0.3.25'
);
