...
sc_p5v3_assert($allowed === ['customer_name', 'supplier_name', 'counterparty_name', 'financial_direction', 'currency_code', 'contract_number', 'payment_reference', 'due_date', 'remaining_amount', 'days_overdue', 'contract_end_date', 'days_until_expiry'], 'SC-P5-021 template placeholder allow-list is explicit, Supplier-aware and stable');
