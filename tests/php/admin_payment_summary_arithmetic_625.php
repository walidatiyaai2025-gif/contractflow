...
sc_625_assert(defined('SAFECONTRACTS_VERSION') && version_compare((string) SAFECONTRACTS_VERSION, '0.2.3', '>='), 'plugin version remains at or above the payment-summary and financial-guard release');
