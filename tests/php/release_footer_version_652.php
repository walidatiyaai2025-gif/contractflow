...
$assert(AdminShell::footerVersion('WordPress 7.1') === 'Version 0.3.14', 'SafeContracts footer renders the canonical plugin version');
...
$assert(AdminShell::footerVersion('WordPress 7.1') === 'الإصدار 0.3.14', 'approved footer version is Arabic on Arabic WordPress profiles');
