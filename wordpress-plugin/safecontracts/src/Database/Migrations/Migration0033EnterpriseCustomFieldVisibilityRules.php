...
final class Migration0033EnterpriseCustomFieldVisibilityRules implements Migration
{
    public function up(object $wpdb): void
    {
        ...
        dbDelta("CREATE TABLE {$conditions} (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
            tenant_id bigint(20) unsigned NOT NULL,
            ...
            KEY tenant_rule_source (tenant_id, rule_id, source_definition_id),
