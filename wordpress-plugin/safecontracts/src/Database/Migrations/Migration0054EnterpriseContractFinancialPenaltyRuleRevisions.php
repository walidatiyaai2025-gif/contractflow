...
final class Migration0054EnterpriseContractFinancialPenaltyRuleRevisions implements Migration
{
    public function up(object $wpdb): void
    {
        ...
        dbDelta("CREATE TABLE {$revisions} (
            ...
            KEY tenant_contract_penalty_mode_state (tenant_id, contract_id, calculation_mode, penalty_rule_state),
            KEY tenant_penalty_rule_profile (tenant_id, financial_currency_profile_id, contract_id)
        ) {$charset};");
    }
}
