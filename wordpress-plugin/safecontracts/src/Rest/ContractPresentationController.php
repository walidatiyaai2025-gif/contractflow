    ...
    public static function show(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        try {
            ...
            return ApiResponse::ok([
                ...
                // Contract cover is deliberately derived from the first scoped
                // image attachment. No duplicate media table or public file path
                // is introduced. Existing plugin upload permissions still apply.
            ...
            unset($error);
            return ApiResponse::error('safecontracts_contract_presentation_failed', __('Unable to load contract presentation data.', 'safecontracts'), 500);
        }
    }
