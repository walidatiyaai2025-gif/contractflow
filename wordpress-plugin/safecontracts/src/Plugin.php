...
final class Plugin
{
    ...
    public function boot(): void
    {
        ...
        CounterpartyArabicDefaults::register();
        ...
        add_action('admin_menu', [SuppliersPage::class, 'register'], 10);
        add_action('admin_menu', [ContractsPage::class, 'register'], 11);
        add_action('admin_menu', [PaymentsPage::class, 'register'], 12);
        add_action('admin_menu', [FinancePage::class, 'register'], 13);
        add_action('admin_menu', [CollectionsPage::class, 'register'], 14);
        add_action('admin_menu', [FollowUpsPage::class, 'register'], 15);
        add_action('admin_menu', [NotificationCenterPage::class, 'register'], 16);
        add_action('admin_menu', [NotificationsPage::class, 'register'], 17);
        add_action('admin_menu', [NotificationSchedulePage::class, 'register'], 18);
        add_action('admin_menu', [ReportsPage::class, 'register'], 19);
        add_action('admin_menu', [ActiveUsersPage::class, 'register'], 20);
        add_action('admin_menu', [UsersRolesPage::class, 'register'], 21);
        add_action('admin_menu', [ArchivePage::class, 'register'], 22);
        add_action('admin_menu', [ImportsPage::class, 'register'], 23);
