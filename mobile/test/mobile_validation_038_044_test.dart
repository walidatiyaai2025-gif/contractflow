...
void main() {
  ...
  test('SC-P9-038 contract light edit remains field and capability bounded',
      () async {
  ...
  test('SC-P9-039 payment list stays bounded filtered and deterministic',
      () async {
    final transport = FakeApiTransport(
      (uri) => _ok(
        <Object?>[_payment()],
  ...
  test('SC-P9-040 payment detail preserves server dates money and status',
      () async {
  ...
  test('SC-P9-041 expected-date edit cannot submit contractual due date',
      () async {
    final transport = FakeApiTransport(
  ...
  test('SC-P9-042 collection entry sends input only and no financial authority',
      () async {
    final transport = FakeApiTransport(
  ...
  test('SC-P9-043 payment methods are server supplied and duplicate-safe',
      () async {
    final transport = FakeApiTransport(
  ...
  test('SC-P9-044 follow-up workflow keeps operational state off balances',
      () async {
