...
void main() {
  ...
  group('SC-P9-031 customer dropdown validation', () {
    ...
    test('unknown customer selection is rejected before network access',
        () async {
  ...
  group('SC-P9-032 dependent contract dropdown validation', () {
    ...
    test('changing customer clears stale dependent options immediately',
        () async {
      final transport = FakeApiTransport(_dashboardHandler);
      final controller = DashboardController(
        repository: DashboardRepository(_client(transport)),
  ...
  group('SC-P9-033 dashboard filtered lists validation', () {
    ...
    test('numeric financial list payloads are rejected instead of recomputed',
        () async {
      final transport = FakeApiTransport((uri) {
  ...
  group('SC-P9-034 mobile Excel export validation', () {
    ...
    test('controller distinguishes forbidden, validation and network failures',
        () async {
  ...
  group('SC-P9-035 customers screen validation', () {
    ...
    test('invalid detail ID fails locally and private fields stay unmodeled',
        () async {
