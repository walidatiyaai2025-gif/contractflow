...
final class _MobileQuickAddScreenState extends State<MobileQuickAddScreen> {
      ...
      children: [
        ...
        if (_canEditContracts) ...[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText:
                  arabic ? 'تاريخ البداية YYYY-MM-DD' : 'Start date YYYY-MM-DD',
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText:
                  arabic ? 'تاريخ النهاية YYYY-MM-DD' : 'End date YYYY-MM-DD',
  ...
  Future<void> _saveCustomer() async {
    ...
    if (email.isNotEmpty &&
      ...
      _message(
          arabic ? 'أدخل بريدًا إلكترونيًا صحيحًا.' : 'Enter a valid email.');
      return;
    }
  ...
  Future<void> _saveContract() async {
    ...
    if (_canEditContracts &&
      ...
      _message(
          arabic ? 'تواريخ العقد غير صحيحة.' : 'Contract dates are invalid.');
      return;
    }
  ...
  Future<void> _savePayment() async {
    ...
    if (!_validRequiredDate(due) || !_validNullableDate(expected)) {
      _message(
          arabic ? 'تواريخ الدفعة غير صحيحة.' : 'Payment dates are invalid.');
      return;
    }
