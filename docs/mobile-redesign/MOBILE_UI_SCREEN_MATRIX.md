...
| CUS-01 | Customers | `CustomersScreen` list/search/filter | customers nav | REF_03 | compact premium cards, current-page search, sort and business-state hierarchy | IMPL | directional layout | adaptive code | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| CUS-02 | Customer detail | customer detail state within feature | customer tap | REF_03 | server-backed financial summary, contracts, receivables, recent activity and copy actions | IMPL | directional layout | adaptive code | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| CUS-03 | Customer add/edit | customer form | detail / authorized create | REF_03 | premium permission-aware form using only supported fields and server mutation endpoints | IMPL | directional layout | sheet scroll-safe | N/A | mutation state | yes | blocked: REF PNG absent | pending runtime |
| SUP-01 | Suppliers | `SuppliersScreen` list/search/filter | suppliers nav | REF_03 | shared premium entity family with payable distinction, status/search/archive filters | IMPL | directional layout | adaptive code | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| SUP-02 | Supplier detail | supplier detail state | supplier tap | REF_03 | payable summary, supplier contracts, upcoming payments, identity and communication actions | IMPL | directional layout | adaptive code | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| SUP-03 | Supplier add/edit | supplier form | detail / authorized create | REF_03 | premium supported-field form preserving server validation and archive semantics | IMPL | directional layout | sheet scroll-safe | N/A | mutation state | yes | blocked: REF PNG absent | pending runtime |
| CON-01 | Contracts | `ContractsScreen` | contracts nav | REF_04 | image-led compact cards, real customer/supplier/status filters, server sort and safe image fallback | IMPL | directional layout | 1/2-column adaptive | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| CON-02 | Contract details | `PremiumContractDetailsScreen` / details | contract tap | REF_04 | hero image, authoritative finance summary, term progress and four-tab composition | IMPL | directional layout | scroll-safe tabs | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| CON-03 | Contract create/edit | create sheet + `ContractEditScreen` | contracts/detail | REF_04 | premium server-supported create/edit fields; contract media upload is not exposed by the current mobile REST mutation surface | IMPL | directional layout | adaptive form | N/A | mutation state | yes | blocked: REF PNG absent | pending runtime |
| CON-04 | Contract summary tab | details tab | contract details | REF_04 | real contract/finance/date summary without cross-currency client recomputation | IMPL | directional layout | adaptive wrap | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| CON-05 | Contract payments tab | details tab | contract details | REF_04 | existing authoritative payment schedule/status data presented inside contract details | IMPL | directional layout | compact rows | yes | yes | yes | blocked: REF PNG absent | pending runtime |
| CON-06 | Contract attachments tab | details tab | contract details | REF_04 | actual attachment label/type/date/link action and MIME icon; size omitted because API does not expose it | IMPL | directional layout | compact rows | yes | yes | yes | blocked: REF PNG absent | pending runtime |
